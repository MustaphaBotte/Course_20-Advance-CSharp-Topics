...
namespace DesktopApp.PersonControl
{
    public partial class ShowPersonWithFilter : UserControl
    {
        ...
        //instead we can use only this line action<int> == public delegate void _OnPersonSelected(int PersonID)
        //but remember  = delegate { } this assign a new empty function just to prevent null call so +1 call in your system

        // This code is unecessary we already give a empty function to prevent null    
        ...
        //Use this
        public event Action<int> OnPersonSelected = delegate { };
